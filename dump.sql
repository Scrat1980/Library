...
INSERT INTO `book` VALUES (5,'Ваш беспокойный подросток','Роберт Т.Байярд, Джин Байярд'),(6,'Семья глазами ребенка','Г.Т.Хоментаускас'),(7,'Мы и наша семья','В.Зацепин, В.Цимбалюк');
...
INSERT INTO `chapter` VALUES (1,1,'ЛЮБОВЬ ТОРЖЕСТВУЕТ НАД ВРЕМЕНЕМ',7),(2,2,'М. ЛЕРМОНТОВ',7),(3,3,'Ф. ТЮТЧЕВ',7),(7,1,'Практическое руководство для отчаявшихся родителей',5),(8,2,'Предисловие',5),(9,3,'Глава 1 Рассмотрим проблему в перспективе',5),(10,1,'РЕБЕНОК ВОСПИТАТЕЛЬ СЕБЯ',6),(11,2,'ВИДИМ ЛИ МЫ ТО ЖЕ ТАК ЖЕ!',6),(12,3,'ПОЧЕМУ В ОДНОЙ СЕМЬЕ - РАЗНЫЕ ДЕТИ!',6);
...
-- Dump completed on 2017-06-19  9:05:32
